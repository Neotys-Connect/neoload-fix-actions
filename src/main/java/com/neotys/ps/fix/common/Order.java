...
public class Order extends Message implements Cloneable {
    ...
    public Order(String log_line) {
        this.ID = setIDFromLogLine(log_line);
        this.symbol = setSymbolFromLogLine(log_line);
        this.quantity = setQtyFromLogLine(log_line);
    }
    ...
    private String setIDFromLogLine(String log_line) {
    ...
    private static String setSymbolFromLogLine(String log_line) {
    ...
    private static int setQtyFromLogLine(String log_line) {
