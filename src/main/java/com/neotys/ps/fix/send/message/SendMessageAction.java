...
public final class SendMessageAction implements Action{
	private static final String BUNDLE_NAME = "com.neotys.ps.fix.send.message.bundle";
	private static final String DISPLAY_NAME = ResourceBundle.getBundle(BUNDLE_NAME, Locale.getDefault()).getString("displayName");
	private static final String DISPLAY_PATH = ResourceBundle.getBundle(BUNDLE_NAME, Locale.getDefault()).getString("displayPath");
	private static final ImageIcon DISPLAY_ICON = new ImageIcon (SendMessageAction.class.getResource(ResourceBundle.getBundle(BUNDLE_NAME,Locale.getDefault()).getString("iconFile")));


	@Override
	public String getType() {
		return "FIXSendMessage";
	}
	...
	public List<ActionParameter> getDefaultActionParameters() {
		...
		for (final SendMessageOption option : SendMessageOption.values()){
	...
	public String getDescription() {
		return "Logon a fix initiator.\n\n"+ Arguments.getArgumentDescriptions(SendMessageOption.values());
	}
